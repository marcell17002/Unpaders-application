...
const AlumniBeritaUnggah = ({navigation}) => {
    return (
        <View>
            <View>
                <Headers type="sub-edit" title="Berita Terunggah"
            ...
            <View style={styles.page}>
                <Gap height={24}/>
                <UnggahBerita title="Universitas Padjadjaran, ptn Terfavorit 2021"
                kategoriBerita="Aktual" subkategoriBerita="Berita" 
