...
const Daftar = ({navigation}) => {
    return (
        ...
        <View style={styles.button}>
            <Buttons title="Daftar sebagai Alumni" 
            onPress={() => navigation.navigate('AlumniDaftar')} />
            <Buttons status="tertiary" title="Daftar sebagai Mahasiswa"
            onPress={() => navigation.navigate('MahasiswaDaftar')}/>
            <Gap height={62}/>
